...
namespace SoundBoard
{
    public static class Helper
    {
        ...
        internal static Keys stringToKey(string str)
        {
            Keys key;
            Enum.TryParse(str, out key);
            return key;
        }
        ...
        internal static bool ChangeKey<TKey, TValue>(this IDictionary<TKey, TValue> dict, TKey oldKey, TKey newKey)
        {
            TValue value;
        ...
        // change Keys code to user friendly string
        internal static string keyToUserFriendlyString(Keys key)
        {
            return null;
        }

        internal static string GetDescription(Keys key)
        {
            switch (key)
            {
                //letters
